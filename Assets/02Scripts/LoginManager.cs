...
//목표: 사용자의 개인정보를 입력하여 저장하거나 (회원가입) 저장된 데이터를 읽어서 개인정보 저장 여부에 따라 로그인하고 싶다.
//필요속성: ID InputField, PW InputField, 인증 텍스트

//목표2: 시스템에 정보가 없다면아이디와 패스워드를 저장해서 회원가입 하고 싶다.
...
public class LoginManager : MonoBehaviour
{
    ...
    //입력이 없을 경우, 입력을 채워달라는 메시지를 인증 텍스트에 띄운다.
